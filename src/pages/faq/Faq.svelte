<script lang="ts">
    ...
    import Form from "../../components/form/FormFaq.svelte";
    import Folder from "../../components/folder/Folder.svelte";
    import CopyButton from "../../components/copyButton/CopyButton.svelte";
    import Settings from "../../components/faqSettings/FaqSettings.svelte";
    import FaqJSONLDGenerator from "../../components/faqJSONLDGenerator/FaqJSONLDGenerator.svelte";
...
<div class="container">
    <a href="/component-library/">Главная</a>
    ...
    <Folder title="JSON-LD">
        <FaqJSONLDGenerator faqs={questions} />
    </Folder>
